...
Boxplot(careless_fss_long, main = "Boxplot do Longstring para o FSS") # 3,20,38 respostas a ser eliminada
...
head(careless_irv_df) # 3,20,5,6

## Anonimizar usuarios e salvar respostas descuidadas e DFS sem respostas descuidadas 

write_csv(fss_dat[c(3,20,38,5,6),], 'data/fss-careless.csv')
write_csv(fss_dat[-c(3,20,38,5,6),], 'data/fss.csv')
