...
<br/>
<p>
<img src=\"https://latex.codecogs.com/png.latex?\\dpi{100}&space;H_{null}:&space;u_{1}&space;=&space;u_{2}\" title=\"H_{null}: u_{1} = u_{2}\" /> (hipótese nula - média dos grupos são iguais)
</p>
<br/>
<p>
